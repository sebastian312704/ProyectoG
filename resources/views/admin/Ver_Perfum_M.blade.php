...
<head>
    ...
    <title>Ver perfume para mujer</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">VER PERFUMES PARA MUJERES</h1>
                    </div>
                            ...
                            @foreach ($datos as $key => $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <!-- Botón de eliminar -->
                                        <a href="{{ route('crud.delete1', $item->id) }}" class="btn btn-danger btn-sm"
